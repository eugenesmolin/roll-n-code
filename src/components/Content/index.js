...
function Content(props) {
    ...
    return (
        <Box width={1} p={3}>
            ...
            <Box border={1} borderColor="primary.main" boxShadow={3} py={2} px={3} position="relative" maxWidth="75%"
                 mx="auto">
                ...
                <Box display="flex" mb={2}>
                    <Box color="primary.main" fontWeight="fontWeightBold" fontStyle="italic"
                         minWidth="100px">Name:</Box>
